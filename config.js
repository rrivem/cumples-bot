...
const base = {
	...
	healthyBreaksSpreadsheet: {
		apiKey: process.env.SPREADSHEET_API_KEY,
		id: process.env.SPREADSHEET_HEALTHY_BREAKS_ID,
		ranges: JSON.parse(process.env.SPREADSHEET_HEALTHY_BREAKS_RANGES),
	},
	slack: {
		...
		channels: {
			...
			healthyBreaks: process.env.SLACK_CHANNELS_HEALTHY_BREAKS,
		},
	},
	googleImages: {
